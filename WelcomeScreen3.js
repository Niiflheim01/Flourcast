...
const ILLUSTRATION_IMAGE = require('../../assets/images/planner.png'); 
    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentArea}>
        ...
        <Text style={styles.title}>
          Bake the right amount, every time
        </Text>
        ...
        <Text style={styles.description}>
          Flourcast predicts demand based on past sales, helping you avoid overproduction and shortages.
        </Text>
      </View>
