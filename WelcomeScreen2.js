...
const ILLUSTRATION_IMAGE = require('../../assets/images/inventory.png'); 
...
const WelcomeScreen2 = () => {
  ...
  const handleContinue = () => {
    ...
    router.push('/(onboarding)/WelcomeScreen3'); 
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentArea}>
        ...
        <Text style={styles.title}>
          Keep track of your ingredients and products easily
        </Text>
        ...
        <Text style={styles.description}>
          Record and monitor your inventory so you always know what's in stock and what needs restocking.
        </Text>
      </View>
