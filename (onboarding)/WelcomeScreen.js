...
const ILLUSTRATION_IMAGE = require('../../assets/images/welcome.png'); 
    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentArea}>
        ...
        <Text style={styles.title}>
          Welcome to <Text style={styles.flourcastText}>Flourcast</Text>
        </Text>
        ...
        <Text style={styles.description}>
          Flourcats helps track your bakery's sales, manage inventory, 
          and plan production all in one place.
        </Text>
      </View>
